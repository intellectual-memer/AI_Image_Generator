...
REPLICATE_API_TOKEN = "r8_avjJDMAbRS2oLO1rtAarvYQaL8aWPHC2RouEv"  # You can store your API key in an environment variable
...
if st.session_state['image_url']:
    ...
    if response.status_code == 200:
        try:
            ...
            st.image(image, caption='Generated Image')  # Pass the PIL Image object directly
        except Exception as e:
            st.error(f"Error loading image: {e}")
    else:
        st.error("Failed to retrieve image from the URL.")
